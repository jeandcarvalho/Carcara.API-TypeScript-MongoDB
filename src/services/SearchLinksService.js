                ...
                if (sVegetationTok) {
                    ...
                    for (const p of parts) {
                        ...
                        if (p === 'low' || p === 'mid' || p === 'high') {
                            ...
                            if (p === 'low')
                                sVegetationRanges.push([0, base.median]);
                            else if (p === 'mid')
                                sVegetationRanges.push([base.median, base.p75]);
                            else if (p === 'high')
                                sVegetationRanges.push([base.p75, undefined]);
                            continue;
                        }
                        const r = parseRange(p);
                        if (r)
                            sVegetationRanges.push(r);
                    }
                }
                // Filtros YOLO
